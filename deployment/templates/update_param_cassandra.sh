...
msk_arn=$(cat stack_resources_output | grep BlogMSKClusterArn | awk '{print $2}')
...
sed -i -e "s/subnet1/$subnet_one/" msk-cassandra-connector.json
sed -i -e "s/subnet2/$subnet_two/" msk-cassandra-connector.json
sed -i -e "s/subnet3/$subnet_three/" msk-cassandra-connector.json
sed -i -e "s#plugin_arn#$connect_arn#g" msk-cassandra-connector.json
sed -i -e "s#bootstrap_brokers#$msk_bootstrap_brokers#g" msk-cassandra-connector.json
sed -i -e "s/msk_sg/$msk_sg/" msk-cassandra-connector.json
sed -i -e "s#msk_role#$msk_role_arn#" msk-cassandra-connector.json
